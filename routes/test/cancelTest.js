...
router.post('', async (req, res) => {
    try {
        ...
        if (req.body.testData.startableFrom) {
            req.body.testData.startableFrom = new Date(req.body.testData.startableFrom);
        }

        if (req.body.testData.startableTill) {
            req.body.testData.startableTill = new Date(req.body.testData.startableTill);
        }
